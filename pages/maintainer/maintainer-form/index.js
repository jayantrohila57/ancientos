...
export default function MaintainerForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault()
    await axios
      .post('https://newwebsite.ancientrom.xyz/ancient/api/Applymainter.php', newRecord)
      .then((result) => {
  ...
  return (
    ...
    >
      <Heading pri="Became Maintainer" sub="Apply for AncientOS Maintainer Form" />
      <Box sx={styles}>
        <Box sx={{ maxWidth: 700 }} component="form" onSubmit={handleSubmit}>
          ...
          <Card sx={(CardStyle, { p: 3, m: 1, mt: 0, mb: 0, borderRadius: 0, maxWidth: 700 })}>
            <Typography variant="h3" align="center" sx={(styles, { width: '100%' })}>
              Social Links
            </Typography>
            <TextField
              sx={typeBoxstyle}
          ...
          >
            ...
            <Typography variant="subtitle" sx={(styles, { width: '100%' })}>
              ...
              <br />
              2) if you are going to build on server it must be 100% private you cant share it with
              your friend <br />
              3) Dont tag admins to get update regarding your forum status <br />
              4) You MUST have a way to check your builds, OWNED the device, TEST it by YOURSELF or
              send the builds for SOMEONE TO TEST. Completely BLINDBUILD and(or) UNTESTED BUILD ARE
              NOT ALLOWED. <br />
              5) You MUST have KNOWLEDGE of git. <br />
              6) You SHOULD have your device sources open for us to verify! <br />
              7) Fixing bug by yourself is a plus! unless its source side. <br />
              8) Under any conditions you cant share rom source with anyone we dont care its your
              BestFriend or the person who paid to get the source <br />
              9) The Device tree must be compitable with lineage os which out any extra patches
              being applied to rom source from your side <br />
