...
export default function Device({ data }) {
  ...
  return (
    <Box sx={{ pt: 5, minHeight: '100vh' }}>
      <Heading pri={`${brandId} Devices`} sub={`Let's see if we have your ${brandId} device.`} />
...
export async function getStaticProps() {
  const DEVICES = 'https://raw.githubusercontent.com/ancient-devices/releases/main/website_api.json'
